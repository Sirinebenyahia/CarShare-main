  ...
  Future<void> _handleCreateRide() async {
    ...
    if (_fromCity == null || _toCity == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(t.t('select_cities')),
    ...
    if (_departureDate == null || _departureTime == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(t.t('select_date_time')),
          backgroundColor: AppTheme.errorRed,
        ),
      );
      return;
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(t.t('ride_created_success')),
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            // Section: Itinéraire
            _buildSectionTitle(t.t('route')),
            const SizedBox(height: 12),

            DropdownButtonFormField<String>(
              value: _fromCity,
              decoration: InputDecoration(
                labelText: t.t('departure_city'),
              ...
              validator: (value) =>
                  value == null ? t.t('departure_city_required') : null,
            ),
            ...
            DropdownButtonFormField<String>(
              ...
              validator: (value) =>
                  value == null ? t.t('arrival_city_required') : null,
            ),
