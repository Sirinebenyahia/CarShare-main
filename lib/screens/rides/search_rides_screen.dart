...
class _SearchRidesScreenState extends State<SearchRidesScreen> {
              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    value: _fromCity != null && AppConstants.tunisianCities.contains(_fromCity) ? _fromCity : null,
                  ...
                  // To City
                  DropdownButtonFormField<String>(
                    value: _toCity != null && AppConstants.tunisianCities.contains(_toCity) ? _toCity : null,
                    decoration: InputDecoration(
  ...
  Widget _buildAdvancedFilters() {
    return Column(
      ...
      children: [
        Text(
          'Prix maximum: ${_maxPrice.toStringAsFixed(0)} TND',
