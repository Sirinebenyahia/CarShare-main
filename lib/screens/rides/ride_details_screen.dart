...
class _RideDetailsScreenState extends State<RideDetailsScreen> {
  ...
  void _navigateToChat() async {
    ...
    // Si l'utilisateur est le conducteur, naviguer vers les discussions du trajet
    if (user.id == widget.ride.driverId) {
      Navigator.pushNamed(context, AppRoutes.rideDiscussions, arguments: widget.ride.id);
      return;
    }

    // Si l'utilisateur est un passager, créer ou ouvrir le chat direct
                    ...
                    builder: (context, auth, _) {
                      return Stack(
                        children: [
                          ...
                          // Badge pour les messages non lus (uniquement pour les passagers)
