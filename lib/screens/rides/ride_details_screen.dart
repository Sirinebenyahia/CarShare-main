...
import 'ride_discussions_screen.dart';
                  ...
                  onPressed: () async {
                    ...
                    if (widget.ride.driverId.isEmpty) {
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Trajet invalide: conducteur manquant'),
                ...
                children: [
                          ...
                          children: [
                            ...
                            if (widget.ride.driverRating >= 4.5)
                              Container(
                                ...
                                child: Text(
                                  AppLocalizations.of(context).t('excellent'),
                                  style: const TextStyle(
                                    fontSize: 12,
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      final isDriver = me.role == UserRole.driver || me.id == widget.ride.driverId;
                      if (isDriver) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => RideDiscussionsScreen(rideId: widget.ride.id),
                          ),
                        );
                        return;
                      }
