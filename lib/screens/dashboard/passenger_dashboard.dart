...
class _PassengerDashboardState extends State<PassengerDashboard> {
          ...
          return ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(t.t('menu_my_bookings')),
                onTap: () {
                  Navigator.pop(context);
                  _showMyBookings();
                },
              ...
              ListTile(
                ...
                title: Text(t.t('menu_my_requests')),
                onTap: () {
                  Navigator.pop(context);
                  _showMyRequests();
                },
              ...
              ListTile(
                ...
                title: Text(t.t('menu_switch_driver')),
                onTap: () {
  ...
  void _showMyBookings() {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => _PassengerBookingsScreen(userId: userId),
      ),
    );
  }
    ...
    showDialog(
      ...
      builder: (context) =>
          AlertDialog(
            ...
            content: const Text(
              'Fonctionnalité à venir: Créez une demande de trajet et les conducteurs pourront vous proposer des trajets correspondants.',
            ),
            actions: [
              TextButton(
                onPressed: () => Navigator.pop(context),
...
class _PassengerBookingsScreen extends StatefulWidget {
  final String userId;

  const _PassengerBookingsScreen({required this.userId});

  @override
  State<_PassengerBookingsScreen> createState() => _PassengerBookingsScreenState();
}

class _PassengerBookingsScreenState extends State<_PassengerBookingsScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await context.read<BookingProvider>().fetchMyBookings(widget.userId);
    });
  }
    ...
    return Scaffold(
      ...
      body: Consumer<BookingProvider>(
        builder: (context, bookingProvider, _) {
          ...
          return RefreshIndicator(
            onRefresh: _refresh,
            child: bookingProvider.myBookings.isEmpty
                ? ListView(
                    children: [
